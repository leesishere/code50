...
# if the file stops pass the last work and the program will start
# collecting the word information after the word passed to the open_and_parse_file
#open_and_parse_file('google-10000-english-no-swears.txt',out_filename, 'caps')
